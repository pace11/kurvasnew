<section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php if (
            $_GET['page'] == 'user' || $_GET['page'] == 'usertambah'||  $_GET['page'] == 'usertambahpro' || $_GET['page'] == 'useredit' || $_GET['page'] == 'usereditpro' || $_GET['page'] == 'userhapus' ||
            $_GET['page'] == 'pengawas'  || $_GET['page'] == 'pengawastambah' || $_GET['page'] == 'pengawastambahpro' || $_GET['page'] == 'pengawasedit' || $_GET['page'] == 'pengawaseditpro' || $_GET['page'] == 'pengawashapus'
            ){echo "active";} ?>">
          <a href="#">
            <i class="fa fa-cogs"></i> <span>Manajemen User</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu ">
            <li class="<?php if($_GET['page'] == 'user' || $_GET['page'] == 'usertambah' || $_GET['page'] == 'usertambahpro' || $_GET['page'] == 'useredit' || $_GET['page'] == 'userhapus') {echo "active";} ?>"><a href="?page=user"><i class="fa fa-circle-o"></i>User</a></li>
            <li class="<?php if($_GET['page'] == 'pengawas' || $_GET['page'] == 'pengawastambah' || $_GET['page'] == 'pengawastambahpro' || $_GET['page'] == 'pengawasedit' || $_GET['page'] == 'pengawaseditpro' || $_GET['page'] == 'pengawashapus') {echo "active";} ?>"><a href="?page=pengawas"><i class="fa fa-circle-o"></i>Pengawas</a></li>
          </ul>
        </li>
        <li class="treeview <?php if (
